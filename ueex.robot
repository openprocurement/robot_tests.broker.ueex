...
Отримати інформацію про questions[1].answer
  Wait Until Page Contains Element    xpath=(//span[contains(@class, 'qa_answer')])[2]
  ${return_value}=  Get text          xpath=(//span[contains(@class, 'qa_answer')])[2]
  [return]  ${return_value}
...
Отримати інформацію про questions[2].answer
  Wait Until Page Contains Element    xpath=(//span[contains(@class, 'qa_answer')])[3]
  ${return_value}=  Get text          xpath=(//span[contains(@class, 'qa_answer')])[3]
  [return]  ${return_value}
...
Отримати інформацію про questions[3].answer
  Wait Until Page Contains Element    xpath=(//span[contains(@class, 'qa_answer')])[4]
  ${return_value}=  Get text          xpath=(//span[contains(@class, 'qa_answer')])[4]
  [return]  ${return_value}
